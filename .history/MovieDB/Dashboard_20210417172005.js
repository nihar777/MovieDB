...
const Dashboard = ({ navigation }) => {
    ...
    function SearchMovie(SearchValue) {
        ...
        axios.get(`https://api.themoviedb.org/3/search/movie?api_key=6f5fae224e38fb668c76e3f839b4d12f&language=en-US&query=${SearchValue}&page=1&include_adult=false`)

            .then(responce => {

                console.log("Mark as Fav..", responce.data.results)

                SetMovieData(responce.data.results)
                console.log("MovieData=>", MovieDataResponce)
                // if(SearchValue==''){
                //     TopRatedMovie()
                // }else{
            ...
            <Header searchBar rounded>
                <Item>
                    <Input onChangeText={(SearchData) => {
                        ...
                        placeholder="Search" />
                    <TouchableOpacity
                        onPress={() => SearchMovie(SearchValue)}>
            ...
            <View style={{ flex: 1 }}>
                ...
                <FlatList
                    ...
                    renderItem={({ item, index }) => {
                        ...
                        console.log("SetMovieData=>", MovieDataResponce)
                        return (
                            <Content>
                                ...
                                <Card style={styles.cardStyle}>
                                        ...
                                        <CardItem>
                                            <Left>
                                                ...
                                                <Body>
                                                    ...
                                                    <Text style={{ fontFamily: 'Montserrat-BlackItalic', }} note>{item.release_date}</Text>
                                                </Body>
                                    ...
                                    <CardItem>
                                        ...
                                        <Right>
                                            <View style={{width:50,height:50,backgroundColor:"black",justifyContent:"center",alignItems:"center",borderRadius:100}}>
                                                <View style={{width:5,height:5,backgroundColor:"green",position:"absolute",justifyContent:"center",alignItems:"center",borderRadius:100}} />
                                                    <View style={{width:40,height:40,backgroundColor:"black",justifyContent:"center",alignItems:"center",borderRadius:100}}>
