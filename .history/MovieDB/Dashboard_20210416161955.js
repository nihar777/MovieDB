...
const Dashboard = ({ navigation }) => {
    ...
    function SearchMovie(SearchValue){
       ...
       axios.get('https://api.themoviedb.org/3/search/keyword?api_key=6f5fae224e38fb668c76e3f839b4d12f&page=1',query)
                ...
                <Header searchBar rounded>
                    <Item>
                        ...
                        onPress={()=>SearchMovie(SearchValue)}>
                            <Icon onPress name="ios-search" /> </TouchableOpacity>
