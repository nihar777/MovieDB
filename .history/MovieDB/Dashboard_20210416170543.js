...
const Dashboard = ({ navigation }) => {
    ...
    function SearchMovie(SearchValue) {
        ...
        axios.get('https://api.themoviedb.org/3/search/movie?api_key=6f5fae224e38fb668c76e3f839b4d12f&language=en-US&query=Dilwale&page=1&include_adult=false')
        ...
        <View style={{ flex: 1, flexDirection: "column" }} >
            <View style={{ flex: 0.09 }}>
                ...
                <Header searchBar rounded>
                    <Item>
                        <Input onChangeText={(SearchData) => SetSearchValue(SearchData)} placeholder="Search" />
                        <TouchableOpacity
                            onPress={() => SearchMovie(SearchValue)}>
                            <Icon onPress name="ios-search" />
                        </TouchableOpacity>
                    </Item>
