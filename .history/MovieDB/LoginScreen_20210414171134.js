...
a  sync function FetchMarkAsFav(){
    console.log("Username is here=>",Username)  
    console.log("Password Is here=>",Password)   
    const Params = {
            username:Username,
    ...
    let res =await axios.post('https://api.themoviedb.org/3/account/{account_id}/favorite?api_key=6f5fae224e38fb668c76e3f839b4d12f&session_id=1c16110db9ecea84ef8a5d29ec9b046af9807759',{
