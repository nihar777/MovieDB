        ...
        <View style={{ flex: 1 }}>  
            <FlatList
                ...
                renderItem={({ item, index }) => {
                    console.log("Flatlist item Data==>",item.poster_path)
                    return (
                        <Content>
                            <Card>
                                <TouchableOpacity
                                    ...
                                    <CardItem>
                                        <Left>
                                            <Thumbnail source={{ uri:'https://www.themoviedb.org/t/p/w600_and_h900_bestv2'+item.poster_path }} />
                                ...
                                <CardItem cardBody>
                                    <Image  resizeMode="containsource={{ uri:'https://www.themoviedb.org/t/p/w600_and_h900_bestv2'+item.poster_path  }} style={styles.bigImageStyle} />
                                </CardItem>
                                <CardItem>
                                    <Left>
                                        <TouchableOpacity
