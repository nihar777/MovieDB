...
const LoginScreen = ({ navigation }) => {
    ...
    await axios.post('https://api.themoviedb.org/3/account/favorite?api_key=6f5fae224e38fb668c76e3f839b4d12f&session_id=1c16110db9ecea84ef8a5d29ec9b046af9807759',body)
    .then(res =>{

        console.log("Markas Fav,..",res)  
    })
    .catch((error)=>{
    console.log("==>LoginError",error.responce)
    })
}
