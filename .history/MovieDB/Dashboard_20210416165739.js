...
const Dashboard = ({ navigation }) => {
    ...
    function SearchMovie(SearchValue) {
        ...
        axios.get('https://api.themoviedb.org/3/search/keyword?api_key=6f5fae224e38fb668c76e3f839b4d12f'&${SearchValue}+'&page=1',SearchValue)

            .then(responce => {

                console.log("SearchSucess", responce)
            })
            .catch((error) => {
