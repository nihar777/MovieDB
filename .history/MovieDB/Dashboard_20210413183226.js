                                ...
                                <Card>
                                    <CardItem>
                                        <Left>
                                            ...
                                            <Body>
                                                <Text style={{fontFamily:'Montserrat-BlackItalic.ttf',}}>{item.title}</Text>
                                                <Text style={{fontFamily:'Montserrat-BlackItalic.ttf',}}note>{item.details}</Text>
                                            </Body>
                                        </Left>
                                    </CardItem>
                                    <CardItem cardBody>
                                    ...
                                    <CardItem>
                                        <Left>
                                            <Button
                                                ...
                                                <Text style={{fontFamily:'Montserrat-BlackItalic.ttf',}}>Mark As Favourite</Text>
                                            </Button>
                                        </Left>
                                    </CardItem>
                                </Card>
