...
const Dashboard = ({ navigation }) => {
    ...
    useEffect(() => {
      ...
      function MarkAsFav(){
        axios.post('https://api.themoviedb.org/3/account/{account_id}/favorite?api_key=6f5fae224e38fb668c76e3f839b4d12f')
        .then(responce =>{

                console.log("Markas Favori=,responce.data.results)  
        })
        .catch((error)=>{
